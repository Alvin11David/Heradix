...
export class SplashCursorComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() BACK_COLOR = { r: 0.5, g: 0, b: 0 };
  @Input() TRANSPARENT = true;
  @Input() RAINBOW_MODE = true;
  @Input() COLOR = '#ff0000';
  ...
  private init(): void {
    ...
    const config: Record<string, any> = {
      ...
      RAINBOW_MODE: this.RAINBOW_MODE,
      COLOR: this.COLOR,
    };
    ...
    function updateFrame() {
      ...
      step(dt);
      render(null);
      self.animationFrameId = requestAnimationFrame(updateFrame);
    }
