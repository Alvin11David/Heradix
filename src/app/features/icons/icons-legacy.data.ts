import { IconAsset, IconAuthor, IconAesthetic, IconTrend, IconPlatform } from '../../core/models/icon.model';
...
type Row = [string, string, string, string[], IconPlatform[], IconAesthetic[], IconTrend, IconAuthor, boolean, boolean, string?];
